# attributed to https://github.com/vincentherrmann/pytorch-wavenet/blob/master/model_logging.py
...
class TensorboardLogger(Logger):
    def __init__(self,
        ...
        #different from the original code to accomodate parallelism
    ...
    def scalar_summary(self, tag, value, step):
        ...
        with self.writer.as_default():
            tf.summary.scalar(tag, int(torch.Tensor.cpu(value)), step=step)
